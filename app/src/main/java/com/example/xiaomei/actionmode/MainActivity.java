package com.example.xiaomei.actionmode;
...
public class MainActivity extends AppCompatActivity {
    ...
    class MultiChoiceListener implements AbsListView.MultiChoiceModeListener {
        ...
        public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
            ...
            mode.setTitle(""+(position+1)+"number"+" Selected");
                ...
                case R.id.select:
...

                    {
                        ...
                        if(mDate.size()==0) {
                            ...
                            mode.setTitle(" No number Selected");

                        } else {

                            mode.setTitle(" All number Selected");
...

                    {
                        ...
                        if(mDate.size()==0) {
                            ...
                            mode.setTitle("number" + (position + 1) + " Selected");
